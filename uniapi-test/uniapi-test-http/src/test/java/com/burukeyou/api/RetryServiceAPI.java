...
public interface RetryServiceAPI {
    ...
    @GetHttpInterface(value = "/retry-web/rt03")
    @HttpFastRetry(briefErrorLog = true, maxAttempts = 4)
    CompletableFuture<BaseRsp<String>> get43(@QueryPar("key") String value, HttpRetryResultPolicy<BaseRsp<String>> policy);


    @GetHttpInterface(value = "/retry-web/rt03")
     @HttpFastRetry(briefErrorLog = true,maxAttempts = 4)
    CompletableFuture<BaseRsp<String>> get44(@QueryPar("key") String value, HttpRetryResponsePolicy<BaseRsp<String>> policy);
