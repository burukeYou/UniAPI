...
public class ValueObjectHashMap<K> extends HashMap<K,Object> implements IMap<K,Object> {

    public ValueObjectHashMap(int initialCapacity, float loadFactor) {
        super(initialCapacity, loadFactor);
    }

    public ValueObjectHashMap(int initialCapacity) {
        super(initialCapacity);
    }

    public ValueObjectHashMap() {
    }

    public ValueObjectHashMap(Map<? extends K, ?> m) {
        super(m);
    }
    ...
    @Override
    public <T> T getObject(K key, Class<T> objClass) {
        return (T)get(key);
    }
    ...
    @Override
    public <T> List<T> getList(K key, Class<T> objClass) {
        Object value = get(key);
        if(value == null){
            return null;
        }
    ...
    @Override
    public <T> T[] getArray(K key, Class<T> objClass) {
        Object value = get(key);
        if(value == null){
            return null;
        }
