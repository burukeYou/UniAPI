 ...
 *
 */
public class UniApiThreadPool extends ThreadPoolExecutor {

    private static final RejectedExecutionHandler rejectedExecutionHandler = new AbortPolicy();

    public UniApiThreadPool(int corePoolSize,
                            int maximumPoolSize,
                            long keepAliveTime,
                            TimeUnit unit) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, null, new UniAPIThreadFactory("uniapi"), rejectedExecutionHandler);
    }
    ...
    public UniApiThreadPool(int corePoolSize,
        ...
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueueSize, new UniAPIThreadFactory("uniapi"), rejectedExecutionHandler);
    }
