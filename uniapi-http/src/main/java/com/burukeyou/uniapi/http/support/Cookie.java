...
public class Cookie implements Serializable {
    ...
    private Cookie(String name, String value, String header) {
        name = name.trim();
    ...
    // class.
    private static List<Cookie> parse(String header, boolean retainHeader) {
        ...
        if (version == 0) {
            ...
            Cookie cookie = parseInternal(header, retainHeader);
            cookie.setVersion(0);
            cookies.add(cookie);
        } else {
            // rfc2965/2109 cookie
            ...
            for (String cookieStr : cookieStrings) {
                Cookie cookie = parseInternal(cookieStr, retainHeader);
                cookie.setVersion(1);
                cookies.add(cookie);
            }
        }
     ...
     *
     * @return  an Cookie being extracted
     *
     * @throws  IllegalArgumentException
     *          if header string violates the cookie specification
     */
    private static Cookie parseInternal(String header,
    ...
    static interface CookieAttributeAssignor {
        public void assign(Cookie cookie,
                           String attrName,
                           String attrValue);
    }

    static final java.util.Map<String, Cookie.CookieAttributeAssignor> assignors =
            new java.util.HashMap<>();

    static {
        assignors.put("comment", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("commenturl", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("discard", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("domain", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("max-age", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
                try {
        ...
        assignors.put("path", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("port", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("secure", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("httponly", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
        ...
        assignors.put("version", new Cookie.CookieAttributeAssignor() {
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
                try {
        ...
        assignors.put("expires", new Cookie.CookieAttributeAssignor() { // Netscape only
            public void assign(Cookie cookie,
                               String attrName,
                               String attrValue) {
                if (cookie.getMaxAge() == MAX_AGE_UNSPECIFIED) {
    ...
    private static void assignAttribute(Cookie cookie,
                                        String attrName,
                                        String attrValue) {
        // strip off the surrounding "-sign if there's any
        attrValue = stripOffSurroundingQuote(attrValue);

        Cookie.CookieAttributeAssignor assignor = assignors.get(attrName.toLowerCase());
        if (assignor != null) {
